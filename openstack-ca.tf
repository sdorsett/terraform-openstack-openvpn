resource "openstack_compute_instance_v2" "openvpn-ca" {
  name            = "openvpn-ca"
  ...
  user_data       = templatefile("${path.module}/cloud-init.tpl", { private_ip = "10.240.0.101" })
  ...
  network {
    ...
    fixed_ip_v4 = "10.240.0.101"
  }

  metadata {
    terraform-openvpn = "openvpn-ca"
  }
